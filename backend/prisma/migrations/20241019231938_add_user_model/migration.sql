...
CREATE TABLE "QueryType" (
    ...
    CONSTRAINT "QueryType_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Query" ADD CONSTRAINT "Query_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "QueryType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
